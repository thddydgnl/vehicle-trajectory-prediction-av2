...
from src.datasets.preprocess_av2 import PreprocessConfig, preprocess_av2
from src.datasets.validate_processed import validate_npz


def _write_mock_scenario(split_dir: Path, scenario_id: str, focal_track_id: str = "focal") -> None:
